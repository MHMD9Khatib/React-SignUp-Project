...
const FormInput = (props) =>{
    ...
    const {label, errorMessage,idType, strengthpass, onChange,mssg ,span, id,eye , ...inputProps}= props; 
    ...
    return (
        <div className="formInput">
            ...
            {/* <input type={setIsVisisble?'text':'password'}/> */}
            <input id={idType} {...inputProps}
            onChange={onChange}
